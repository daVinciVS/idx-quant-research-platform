...
def build_market_chart(
    ...
    *,
    ...
    """Build a daily OHLCV research chart for public or demo data."""
    ...
    bodies = (
        ...
        .encode(
            x=x_encoding,
            y=alt.Y("Open:Q", scale=price_scale, axis=None),
            y2="Close:Q",
            color=alt.condition(
    ...
    sma20 = (
        ...
        .encode(
            x=x_encoding,
            y=alt.Y("SMA20:Q", scale=price_scale, axis=None),
            tooltip=[
                alt.Tooltip("Date:T", title="Date", format="%d %b %Y"),
    ...
    sma50 = (
        ...
        .encode(
            x=x_encoding,
            y=alt.Y("SMA50:Q", scale=price_scale, axis=None),
            tooltip=[
                alt.Tooltip("Date:T", title="Date", format="%d %b %Y"),
    ...
    layers: list[alt.Chart] = [high_low, bodies, sma20, sma50]
    ...
    if trade_plan is not None:
        ...
        layers.append(
            ...
            .encode(
                y=alt.Y("Price:Q", scale=price_scale, axis=None),
    ...
    layers.append(latest_marker)

    price_chart = alt.layer(*layers).properties(
        height=420,
        title=alt.TitleParams(
            f"{ticker} daily OHLCV with technical overlays",
            anchor="start",
            color="#E8EDF2",
            fontSize=15,
            fontWeight=600,
    ...
    return (
        alt.vconcat(price_chart, volume_chart, spacing=8)
...
def build_demo_market_chart(
    ...
    """Build the public-demo chart with its stable legacy API."""
    return build_market_chart(
        frame,
        ticker="Synthetic OHLCV fixture",
